...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'music_music', (
            ...
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='music', to=orm['profiles.SurmandlUser'])),
            ('album_image_url', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'music', ['Music'])


    def backwards(self, orm):
        # Deleting model 'Music'
        db.delete_table(u'music_music')
    ...
    models = {
        ...
        u'music.music': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'music'", 'to': u"orm['profiles.SurmandlUser']"}),
            'album_image_url': ('django.db.models.fields.TextField', [], {}),
